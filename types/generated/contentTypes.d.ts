...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    role: Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    tg_id: Attribute.UID & Attribute.Required;
    avatar: Attribute.String;
    language_code: Attribute.String &
      Attribute.Required &
      Attribute.DefaultTo<'eng'>;
    premium: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<false>;
    lastVisit: Attribute.DateTime & Attribute.Required;
    activeDays: Attribute.Integer & Attribute.Required & Attribute.DefaultTo<0>;
    lastActiveDate: Attribute.DateTime;
...
export interface ApiPracticePractice extends Schema.CollectionType {
  ...
  attributes: {
    title: Attribute.String & Attribute.Required;
    breathDuration: Attribute.Integer &
      Attribute.Required &
      Attribute.DefaultTo<3>;
    exhaleDuration: Attribute.Integer &
      Attribute.Required &
      Attribute.DefaultTo<5>;
    breathHold: Attribute.Integer & Attribute.Required & Attribute.DefaultTo<3>;
    exhaleHold: Attribute.Integer & Attribute.Required & Attribute.DefaultTo<3>;
    duration: Attribute.Integer & Attribute.Required & Attribute.DefaultTo<5>;
    sound: Attribute.Relation<
...
export interface ApiSoundSound extends Schema.CollectionType {
  ...
  attributes: {
    title: Attribute.String & Attribute.Required;
    soundMedia: Attribute.Media<'images' | 'files' | 'videos' | 'audios'> &
      Attribute.Required;
    free: Attribute.Boolean & Attribute.Required & Attribute.DefaultTo<true>;
    iconMedia: Attribute.Media<'images' | 'files' | 'videos' | 'audios'> &
      Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
